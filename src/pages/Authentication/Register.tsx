...
// action
import { SignupAction } from "../../slices/thunks";
...
const Register = (props: any) => {
      ...
      dispatch(SignupAction(values)).then(
        (res: {
          ...
          if (res.type === "auth/signup/fulfilled") {
            ...
            const { success, message, token } = res.payload;
            if (success && message === "REGISTER_SUCCESS") {
  ...
  document.title = "Basic SignUp | Ahln - React Admin & Dashboard Template";
                  ...
                  <CardBody className="p-4">
                    <div className="text-center mt-2">
                      ...
                      <p className="text-muted">
                        Get your free Ahln Box account now
                      </p>
                    </div>
                    <div className="p-2 mt-4">
                      ...
                      >
                        ...
                        {error && error ? (
                          <Alert color="danger">
                            <div>
                              Phone Number has been Register Before, Please Use
                        ...
                        <div className="mb-4">
                          <p className="mb-0 fs-12 text-muted fst-italic">
                            By registering you agree to the DCC ...
                            <Link
                              to="#"
